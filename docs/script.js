...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      inpits = document.querySelectorAll('input'),
...
var modals = function modals() {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', 'block', false); // showModalByTime('.popup', 60000);
};
